  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 text-center max-w-3xl reveal reveal-slow ${visible ? "is-visible" : ""}`}>
        <p className="font-serif-light tracking-[0.5em] text-charcoal-mute text-xs mb-8">ԳԼՈՒԽ · 03</p>
        <p className="font-script text-gold text-3xl md:text-4xl mb-10">մեր ընտանիքների հետ միասին</p>
        ...
        <div className="flex items-center justify-center gap-8 my-12">
          ...
          <div className="text-center">
            <p className="font-serif-light text-charcoal-mute uppercase tracking-[0.4em] text-xs mb-2">Պահեք օրը</p>
            <p className="font-display text-charcoal text-3xl md:text-4xl">14 · 09 · 2026</p>
            <p className="font-serif-light italic text-charcoal-mute mt-2">Վիլլա Բելմոնտե · Կոմո լիճ</p>
          </div>
          <div className="h-px w-16 bg-gold/60" />
        </div>

        <p className="font-serif-light text-charcoal-mute text-xl md:text-2xl italic max-w-xl mx-auto leading-relaxed">
          «Եվ նրա ժպիտում ես տեսա մի բան, որ ավելի գեղեցիկ էր, քան աստղերը»։
        </p>
      </div>
    </section>
  );
